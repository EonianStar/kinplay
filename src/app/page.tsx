...
export default function HomePage() {
  ...
  return (
    <div className="flex flex-col bg-gradient-to-br from-indigo-50 via-white to-purple-50">
      {/* 主要内容区域 */}
      <main className="flex-grow py-16 sm:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
          <div className="text-center">
            <h1 className="text-6xl font-bold mb-12 bg-gradient-to-br from-[#1b4dff] to-[#ff51e3] text-transparent bg-clip-text leading-normal">
              KinPlay
            </h1>
